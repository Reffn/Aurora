    ...
    if (Platform.isAndroid) {
      settings = AndroidSettings(
        ...
        foregroundNotificationConfig: ForegroundNotificationConfig(
          ...
          enableWakeLock: true,
          // Die Silhouette, nicht das Startsymbol: Android liest bei
          // Meldungssymbolen nur den Alphakanal. Das bunte `ic_launcher`
          // wurde in der Leiste zu einem leeren weißen Ring — sichtbar
          // wurde das erst, als die übrigen Meldungen schon das Chamäleon
          // trugen und diese eine daneben weiter blank blieb.
