...
class FirestoreTelemetryTransport implements TelemetryTransport {
  ...
  // Dieselbe Prüfung wie beim Feedback-Kanal — und zwar buchstäblich
  // dieselbe. Sie stand hier und dort Zeichen für Zeichen gleich; siehe
  // `firestore_bereitschaft.dart`, warum ausgerechnet sie nicht doppelt
  // liegen darf.
