...
/// [texts] gibt die Sprache vor. Ohne Angabe gilt die globale — die ist für
/// Dienste ohne `BuildContext` da und trägt, was zuletzt gebaut wurde.
///
/// Wer einen Context hat, muss sie mitgeben. Sonst steht der Rahmen in der
/// Sprache des Schirms und die Zeitangabe darin in einer anderen: Auf der
/// Profilauswahl stand am 14.08.2026 „zuletzt 6 minuti fa". Aurora hängt die
/// Sprache an den Anteil, also laufen die beiden bei jedem Wechsel
/// auseinander.
String formatPositionAge(Duration age, {AppLocalizations? texts}) {
  texts ??= AppTexts.current;
