...
- **Romys gemalte Fünf** (`assets/images/`, 6. August, Commit `406a460`):
...
nebeneinander stehen. Die Auflösung ist nicht, Romys Fünf anzugleichen,
...
4. **B1** — die sieben Schablonen-Chamäleons in Romys Stil nachziehen.
   Handarbeit, größter sichtbarer Ertrag. **Nicht** andersherum: Romys Fünf
   sind das Ziel.
